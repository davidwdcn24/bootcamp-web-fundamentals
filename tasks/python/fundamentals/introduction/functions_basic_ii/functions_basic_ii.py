...
def countdown(numMax) :
    resultado = []
    for x in range(numMax, -1, -1) :
        resultado.append(x)
    return resultado
print(countdown(5))
...
"""
def printAndSet(list_number) :
    print(list_number[0])
    return list_number[1]
print(printAndSet([1,2]))
...
"""
def firstAndLenght(list_number) :
    suma = list_number[0] + len(list_number)
    return suma
print(firstAndLenght([1,2,3,4,5]))
...
"""
def maxValueThanSecond(list_number) :
    if (len(list_number) < 2) :
        return False
    resultado = []
    # for x in range(0, len(list_number)) :
    #     if (x == (len(list_number) - 1)) :
    #         resultado.append(list_number[x])
    #     else :
    ...
    for x in range(0, len(list_number)) :
        if(list_number[x] > list_number[1]) :
            resultado.append(list_number[x])
    return resultado
print(maxValueThanSecond([5,2,3,2,1,4]))
print(maxValueThanSecond([3]))
